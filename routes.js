...
exports.endpoints = [{method: 'GET', path: '/', config: {handler: function(request, reply){reply('API v1, DINAF')}}},
	...
	{method: 'POST', path: '/v1/createScope', config: scopesController.createScope},
	{method: 'GET', path: '/v1/scopes', config: scopesController.getScopes},
	{method: 'PUT', path: '/v1/scope/{scopeId}', config: scopesController.editScope},
	{method: 'DELETE', path: '/v1/scope/{scopeId}', config: scopesController.deleteScope},
	{method: 'GET', path: '/v1/scope/{scopeId}', config: scopesController.getScopebyId}
	];
